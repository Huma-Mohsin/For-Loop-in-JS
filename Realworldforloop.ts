...
let students: string[] = ["Huma", "Ayesha", "Sania", "Aima", "Sara"];
...
let values: number[] = [2, 3, 4, 5, 6, 7, 8];
let sum = 0;
...
console.log(
  "Performing operations on a batch of items, such as sending emails, processing orders, or updating records."
);

function sendEmails(email: string) {
